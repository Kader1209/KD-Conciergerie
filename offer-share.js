(function () {
  ...
  const getShareButtonIcon = () => `
    <svg viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
      <path
        fill="currentColor"
        d="M8.25 3A2.25 2.25 0 0 0 6 5.25v11.5A2.25 2.25 0 0 0 8.25 19h8.5A2.25 2.25 0 0 0 19 16.75v-3a1 1 0 1 0-2 0v3a.25.25 0 0 1-.25.25h-8.5a.25.25 0 0 1-.25-.25V5.25A.25.25 0 0 1 8.25 5h3a1 1 0 1 0 0-2h-3Z"
      />
      <path
        fill="currentColor"
        d="M9.4 14.75a1 1 0 0 1-.98-1.2c.52-2.55 1.72-4.62 3.62-6.18 1.63-1.35 3.55-2.14 5.73-2.37l-1.57-1.52a1 1 0 1 1 1.4-1.44l3.47 3.37a1.25 1.25 0 0 1 0 1.79l-3.47 3.37a1 1 0 1 1-1.4-1.44l1.52-1.47c-1.59.15-2.99.68-4.22 1.61-1.45 1.09-2.39 2.54-2.86 4.39a1 1 0 0 1-1.24.72Z"
      />
    </svg>
  `;
