(function () {
  ...
  const getShareButtonIcon = () => `
    <svg viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
      <path
        fill="currentColor"
        d="M6.85 18.42a1.08 1.08 0 0 1-.76-1.86c1.43-1.46 3-2.57 4.7-3.32 1.45-.64 2.96-.99 4.54-1.06V9.55a1.08 1.08 0 0 1 1.81-.8l4.67 4.34a1.08 1.08 0 0 1 0 1.58l-4.67 4.34a1.08 1.08 0 0 1-1.81-.8v-1.98c-1.41.05-2.75.28-4.03.69-1.53.49-2.95 1.26-4.26 2.3-.06.05-.13.1-.19.14Z"
      />
    </svg>
  `;
