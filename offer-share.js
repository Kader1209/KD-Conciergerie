(function () {
  ...
  const getShareButtonIcon = () => `
    <svg viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
      <path
        fill="currentColor"
        d="M12 3a1 1 0 0 1 1 1v8.59l2.29-2.29a1 1 0 1 1 1.42 1.4l-4 4.01a1 1 0 0 1-1.42 0l-4-4a1 1 0 1 1 1.42-1.41L11 12.6V4a1 1 0 0 1 1-1Z"
      />
      <path
        fill="currentColor"
        d="M7.25 9A2.25 2.25 0 0 0 5 11.25v7.5A2.25 2.25 0 0 0 7.25 21h9.5A2.25 2.25 0 0 0 19 18.75v-7.5A2.25 2.25 0 0 0 16.75 9H15a1 1 0 1 0 0 2h1.75c.14 0 .25.11.25.25v7.5a.25.25 0 0 1-.25.25h-9.5a.25.25 0 0 1-.25-.25v-7.5c0-.14.11-.25.25-.25H9a1 1 0 1 0 0-2H7.25Z"
      />
    </svg>
  `;
