(function () {
  ...
  const getShareButtonIcon = () => `
    <svg viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        fill="currentColor"
        d="M4 6.75A2.75 2.75 0 0 1 6.75 4h3a1 1 0 1 1 0 2h-3A.75.75 0 0 0 6 6.75V19a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V6.75A.75.75 0 0 0 17.25 6h-3a1 1 0 1 1 0-2h3A2.75 2.75 0 0 1 20 6.75V19a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3V6.75Z"
      />
    </svg>
  `;
